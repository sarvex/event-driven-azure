...
namespace Invoices.Data.Services
{
    ...
    {
        Task ConvertFirstPageWordToSVG(string id, MemoryStream file);
    ...
    public class InvoiceFileService : IInvoiceFileService
    {
        ...
        public async Task ConvertInvoiceToAllFormats(string invoiceId)
        {
            ...
            using (var file = new MemoryStream())
            {
                ...
                await ConvertFirstPageWordToSVG(invoiceId, file);
        ...
        public async Task ConvertFirstPageWordToSVG(string id, MemoryStream file)
        {
