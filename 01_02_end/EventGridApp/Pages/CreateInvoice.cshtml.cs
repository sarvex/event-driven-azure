...
namespace EventGridApp.Pages
{
    public class CreateInvoiceModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            //generate invoice word template using invoice data
            await _invoiceFileService.GenerateInvoice(newInvoice);

            //convert invoice to various formats. Png, html, pdf
            await _invoiceFileService.ConvertInvoiceToAllFormats(newInvoice.Id);
